...
- [4. 管理员功能](#4-管理员功能)
  - [4.1 仪表盘](#41-仪表盘)
  - [4.2 用户管理](#42-用户管理)
  - [4.3 OAuth 配置](#43-oauth-配置)
  - [4.4 SAML SSO 配置](#44-saml-sso-配置)
  - [4.5 模型配置](#45-模型配置)
    - [4.5.1 模型提供商](#451-模型提供商)
    - [4.5.2 配置模型提供商](#452-配置模型提供商)
    - [4.5.3 添加模型](#453-添加模型)
  - [4.6 AI 网关](#46-ai-网关)
    - [4.6.1 前置条件：创建阿里云 AI 网关](#461-前置条件创建阿里云-ai-网关)
    - [4.6.2 在管理平台中配置 AI 网关](#462-在管理平台中配置-ai-网关)
    - [4.6.3 AI 网关启用后的效果](#463-ai-网关启用后的效果)
  - [4.7 Token 统计与限流](#47-token-统计与限流)
    - [4.7.1 Token 统计](#471-token-统计)
    - [4.7.2 全局限流配置](#472-全局限流配置)
    - [4.7.3 个人限流配置](#473-个人限流配置)
  - [4.8 实例列表（管理员视图）](#48-实例列表管理员视图)
  - [4.9 渠道配置](#49-渠道配置)
  - [4.10 配置模板](#410-配置模板)
  - [4.11 技能配置](#411-技能配置)
- [5. 用户功能](#5-用户功能)
  - [5.1 实例列表](#51-实例列表)
  - [5.2 创建 OpenClaw 实例](#52-创建-openclaw-实例)
  - [5.3 实例详情与配置](#53-实例详情与配置)
  - [5.4 暂停与重启实例](#54-暂停与重启实例)
  - [5.5 用户侧 Token 用量概览](#55-用户侧-token-用量概览)
